...
config:
	...
	REPLICA=02 SHARD=02 envsubst < config.xml > clickhouse02/config.xml
	REPLICA=03 SHARD=03 envsubst < config.xml > clickhouse03/config.xml
	REPLICA=04 SHARD=04 envsubst < config.xml > clickhouse04/config.xml
